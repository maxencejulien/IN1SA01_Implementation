...
################################################################################
    ...
    def afficherImage(self, x, y, filename, centrage="nw"):
        ...
        return ObjetGraphique(self.create_image(x, y, image=img, anchor=centrage), x, y, None)
...
def ouvrirFenetre(x=400, y=200, titre='tk'):
    racine = tk.Tk()
    racine.title(titre)
